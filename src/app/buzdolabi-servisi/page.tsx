...
export default function BuzdolabiServisiPage() {
  ...
  return (
    <>
      ...
      <Hero 
        ...
        subtitle="Türkiye genelinde tüm buzdolabı markaları için profesyonel servis, bakım ve arıza tamiri hizmetleri."
      />
      ...
      <section className="py-8 bg-gradient-to-b from-white via-blue-50/30 to-white relative overflow-hidden">
        ...
        <Container className="relative z-10">
          <div className="max-w-3xl">
            <p className="text-slate-700 leading-relaxed">Buzdolabı servisi kapsamında tüm buzdolabı markalarınız için arıza tespiti, tamir, bakım ve montaj hizmetleri sunuyoruz. Soğutmama, dondurma, buzlanma, sesli çalışma ve elektronik kart arızaları için uzman teknisyenlerimizle hizmetinizdeyiz.</p>
          </div>
        </Container>
      </section>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-b from-white via-blue-50/30 to-white relative overflow-hidden">
        ...
        <Container className="relative z-10">
          <SectionHeader 
            icon={Refrigerator}
            title="Buzdolabı Servis Hizmetleri"
            subtitle="Tüm buzdolabı markalarında arıza tespiti, tamir, bakım ve montaj hizmetleri"
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="border border-slate-200 hover:border-blue-900 hover:shadow-xl transition-all duration-300 rounded-2xl bg-white">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Soğutmama</h3>
                <p className="text-slate-600 mb-4">
                  Buzdolabının soğutmama sorunu, kompresör arızaları ve soğutma gazı kontrolleri.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border border-slate-200 hover:border-blue-900 hover:shadow-xl transition-all duration-300 rounded-2xl bg-white">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Kompresör Arızası</h3>
                <p className="text-slate-600 mb-4">
                  Kompresör çalışmıyor, aşırı gürültü veya sürekli çalışma problemleri.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border border-slate-200 hover:border-blue-900 hover:shadow-xl transition-all duration-300 rounded-2xl bg-white">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Termostat</h3>
                <p className="text-slate-600 mb-4">
                  Termostat ayarları, sıcaklık sensörü ve elektronik kart kontrolleri.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border border-slate-200 hover:border-blue-900 hover:shadow-xl transition-all duration-300 rounded-2xl bg-white">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Su Damlacığı</h3>
                <p className="text-slate-600 mb-4">
                  Buzdolabı içinde su birikmesi, damlama ve tıkanıklık problemleri.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border border-slate-200 hover:border-blue-900 hover:shadow-xl transition-all duration-300 rounded-2xl bg-white">
              <CardContent className="p-6">
                <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center mb-4">
                  <Snowflake className="w-5 h-5 text-blue-900" />
                </div>
                <h3 className="text-xl font-bold text-slate-900 mb-3">No-Frost</h3>
                <p className="text-slate-600 mb-4">
                  No-frost sistemi çalışmıyor, aşırı buzlanma ve defrost arızaları.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border border-slate-200 hover:border-blue-900 hover:shadow-xl transition-all duration-300 rounded-2xl bg-white">
              <CardContent className="p-6">
                ...
                <p className="text-slate-600 mb-4">
                  Buzdolabının ömrünü uzatmak için düzenli bakım hizmetleri.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-12 bg-gradient-to-b from-white via-blue-50/30 to-white relative overflow-hidden">
        ...
        <Container className="relative z-10">
          <SectionHeader 
            icon={MapPin}
            title="Şehir Bazlı Buzdolabı Servisi"
          />
          
          <div className="flex flex-wrap justify-center gap-3">
            {cityPages.map((city) => (
              <Link key={city.id} href={`/${city.slug}/buzdolabi-servisi`}>
